...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v2.8.0
>
...
![status](https://img.shields.io/badge/version-v2.8.0-brightgreen) ![node](https://img.shields.io/badge/node-62-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🛡️ **v2.8.0 Provider 生成下载与 RH 跨站修复版**：自定义 RunningHub WebApp 查询、提交、轮询、取消和上传会在上游明确返回站点归属/身份错误时安全尝试另一站，`.cn` 与 `.ai` 不再依赖用户手动猜站点；同步延长 Seedream V5 Pro 同步响应时限、可靠持久化 Creator 超长流式回复，并收紧 seedance.nz 上传重试边界，保留 v2.7.4 以来的系统代理、TUN、VPN、IPv4/IPv6 与安全下载能力。
