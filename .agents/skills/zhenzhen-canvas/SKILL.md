...
- The current released desktop and automatic-update baseline is `v2.8.4`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.4>. It is published, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.4` release Tag and Release target point to packaged-source commit `249e36285ea608686bc3a5975d1f5e887697f2ae`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.8.4 flow produced exactly one final Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.4.exe` is 1,238,238,783 bytes with SHA-256 `349a34fab69ce0f1906fee96ebb85a3288d24d25b35be963efaa452d53a888df`; its blockmap is 1,291,109 bytes with SHA-256 `e7526a6da08a54acead4701e146a3787d2f3d1764908d0ad21dac13e72519e8f`; `latest.yml` is 362 bytes with SHA-256 `b06bae762c886aa83be6a0e7f96fadfcb1a2e016f6145363fee78783d10de5a9`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
- Affected-user installation, multi-device collaboration, installed-upgrade, and full live Provider quality evidence remains explicitly deferred under `owner-approved-post-release-v2.8.4` and must never be reported as passed before it exists.
