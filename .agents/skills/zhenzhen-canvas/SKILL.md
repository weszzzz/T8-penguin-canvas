...
- The current released desktop and automatic-update baseline is `v2.8.0`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.0>. It is published, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.0` release Tag and Release target point to packaged-source commit `2b984be4696a9abe3627832e3d39ba02f7338fdb`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.8.0 flow produced exactly one actual Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.0.exe` is 1,317,437,404 bytes with SHA-256 `4daf8baaa995e8b96b868b5202041b1f27bcd68df6f349b189c05815c9e4392e`; its blockmap is 1,372,947 bytes with SHA-256 `c4efcfb24db6d8638d79f33601ed80063b61f92e29b452b0852c9dc982a5511a`; `latest.yml` is 362 bytes with SHA-256 `d023c4c3ef8995875c78d16c1feac757fd60bda6c1df4a8081dde4d00941f344`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish remote re-download, final Latest verification, and recovery cleanup passed.
