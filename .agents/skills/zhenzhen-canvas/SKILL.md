...
- The current released desktop and automatic-update baseline is `v2.8.3`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.3>. It is published, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.3` release Tag and Release target point to packaged-source commit `81a650176d801a91ee20f2dfd9f5255491d8e887`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.8.3 flow produced exactly one final Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.3.exe` is 1,317,546,643 bytes with SHA-256 `a02140459368b4e827570284b72b9ab7e3156e3f526529885fe0ee56af63db15`; its blockmap is 1,373,503 bytes with SHA-256 `3de4f12cdf52f547586da6c193eeb7eb7f178482c40e6bf17529b643dcc0a949`; `latest.yml` is 362 bytes with SHA-256 `8bdbf92524e39a5d26ac322b70b60cf156a25b39d8274cba246005fd5934dfc4`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
