...
- The current released desktop and automatic-update baseline is `v2.7.8`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.7.8>. It is published, non-prerelease, and GitHub Latest.
- Its immutable `v2.7.8` release Tag and Release target are fixed to packaged-source commit `2048a00273353ce7b82837be734a58f578d06408`. Later metadata-only commits on `main` must not move that Tag.
