...
- The current released desktop and automatic-update baseline is `v2.8.7`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.7>. It is published, non-draft, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.7` release Tag and Release target point to packaged-source commit `fd537fa5ea2fc5feb56d20264606d7e2e153fdc2`. Later metadata-only commits on `main` must not move that Tag.
...
- The v2.8.7 flow produced one final Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.7.exe` is 1,317,595,130 bytes with SHA-256 `680fdc7e2f48e7519f27bf8033938ed37d6923630bfea2f8a920634b038d235a`; its blockmap is 1,372,744 bytes with SHA-256 `bf341dbfe0c781d39ec22b7b68911c71b3333e9750f73ae88f4fac6c77cfaff2`; `latest.yml` is 362 bytes with SHA-256 `77a66cef07b4cdd947e63c1bfb1d249d66634c8fb4541cc7f34ffebea8769292`. Post-build, provenance, sealed recovery, exact draft ownership, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
- Affected-user installation, Fast I2V and quota-blocked domestic H3 Provider quality, multi-device collaboration, and installed-upgrade evidence remain explicitly deferred under `owner-approved-post-release-v2.8.7` and must never be reported as passed before they exist.
