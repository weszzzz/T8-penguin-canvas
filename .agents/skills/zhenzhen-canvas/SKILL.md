...
- The current released desktop and automatic-update baseline is `v2.7.9`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.7.9>. It is published, non-prerelease, and GitHub Latest.
- Its fixed `v2.7.9` release Tag and Release target point to packaged-source commit `8aa5d2fa50d4ccc9ee9d32a0580cc09879e718d1`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.7.9 flow produced exactly one actual Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.7.9.exe` is 1,317,434,488 bytes with SHA-256 `71e1abc7efd6216de6aa815d29c223d05192bcd31ccd02f527bc65d95b71e9ac`; its blockmap is 1,373,191 bytes with SHA-256 `50d27a9a670ccf85ce477c066ac01f05ea44c0a884ca0d5f5d82b513cfde9e77`; `latest.yml` is 362 bytes with SHA-256 `f0eb9c13104b933a4b38c6752c5cccfc3015cbcd01a89b3c12fad69555b9970b`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish remote re-download, final Latest verification, and recovery cleanup passed.
