...
- The current released desktop and automatic-update baseline is `v2.8.2`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.2>. It is published, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.2` release Tag and Release target point to packaged-source commit `435a8bee730bd7a21147f5d7ebc11ca5b0c41e91`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.8.2 flow produced exactly one actual Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.2.exe` is 1,317,462,098 bytes with SHA-256 `7f2804c22697bc3f58b46c13696c485bbd6f0b154d387c5247cb50ad96922abd`; its blockmap is 1,373,311 bytes with SHA-256 `fb2ac48b18813b08c07cf308636ee5e497861e2fd68e56eb7556372cdd3dc53e`; `latest.yml` is 362 bytes with SHA-256 `3f85df3e8a4ac8617bf4edf5b160bd46570c6dfdb69e19728d2b19a16b8d8fa5`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
